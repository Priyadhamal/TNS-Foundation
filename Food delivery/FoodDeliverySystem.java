...
public class FoodDeliverySystem {
    ...
    private List<Delivery> deliveryPersons;
    ...
    public void addFoodItemToRestaurant(int restaurantId, int foodItemId, String name, double price) {
        ...
        if (restaurant != null) {
            restaurant.addFoodItem(new Food(foodItemId, name, price));
    ...
    public void viewRestaurantsAndMenus() {
        ...
        for (Restaurant restaurant : restaurants) {
            ...
            for (Food item : restaurant.getMenu()) {
    ...
    public void addDeliveryPerson(int id, String name, long contactNo) {
        deliveryPersons.add(new Delivery(id, name, contactNo));
    ...
    public void assignDeliveryPerson(int orderId, int deliveryPersonId) {
        ...
        Delivery deliveryPerson = findDeliveryPersonById(deliveryPersonId);
    ...
    public void addFoodToCart(int customerId, int restaurantId, int foodItemId, int quantity) {
        ...
        if (customer != null && restaurant != null) {
            Food foodItem = findFoodItemInRestaurant(restaurant, foodItemId);
            if (foodItem != null) {
    ...
    private Delivery findDeliveryPersonById(int id) {
    ...
    private Food findFoodItemInRestaurant(Restaurant restaurant, int foodItemId) {
